...
export const hasPutAttributes: <A extends object, RV extends PutReturnValues>(
...
export const hasUpdateAttributes: <A extends object, RV extends UpdateReturnValues>(
